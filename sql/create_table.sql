# 数据库初始化
-- 创建库
create database if not exists duck_oj;
...
(
    ...
    judgeCase   text                               null comment '判题用例，输入输出用例（json 数组）',
...
(
    ...
    judgeInfo     text                            null comment '提交题目信息',
    submitLanguage     varchar(128)               not null comment '提交语言',
    submitCode     text                           not null comment '提交代码',
    ...
    index idx_userId (userId)
) comment '提交题目表'collate = utf8mb4_unicode_ci;
